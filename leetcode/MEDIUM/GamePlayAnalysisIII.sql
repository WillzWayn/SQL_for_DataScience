...
-- sum(games_played) over(partition by player_id order by player_id, event_date) as games_played
-- from Activity
...
select t1.player_id, t1.event_date, sum(t2.games_played) as total
